...
def indexmaker( foldername,filename ):
    ...
    o.write('  <link rel="stylesheet" type="text/css" href="https://planetearth.utsc.utoronto.ca/diagrams/style.css?v=1.0"/>\n')
    ...
    o.write('    <img src="https://planetearth.utsc.utoronto.ca/diagrams/media-fullscreen.png" alt="Expand image">\n')
    o.write("  </a>\n")
    ...
    for line in lines:
    	...
    	if m:
    		...
    		for row in tab:
    			...
    			#	pdb.set_trace()
    			if  pid == path_id:
    				new_string = 'path class="tooltip" title="<strong>%s</strong><br>%s" xlink:href="#%s" role="img" aria-label="%s" tabindex="1" '%(row[2], row[3], row[1], row[5])
